...
def train():
	...
	checkpoint_path = os.path.join(OUTPUT_DIR, DATA_SOURCE_DIR, dataset.data_source, MODEL_CHECKPOINT_FILENAME)
	...
	for epoch in range(EPOCHS):
		...
		for batch_idx, batch in enumerate(dataloader):
			...
			# Ensure action sequence has fixed length (WINDOW_SIZE).
